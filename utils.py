...
def get_or_create_chroma_collection(_db_client, module_content_fp, _ai_client):
    ...
    try:
        collection = _db_client.get_collection(name=collection_name, embedding_function=embedding_function)
        ...
        collection = _db_client.create_collection(name=collection_name, embedding_function=embedding_function)
        collection.add(
            documents=chunks,
